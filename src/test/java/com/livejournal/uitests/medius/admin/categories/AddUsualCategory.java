...
public class AddUsualCategory extends LJTest {
    ...
    public void editor_add_new_category_on_Categories_Page(String symbol_in_keyword) {
        ...
        onOpened(AdminMediusCategory.class)
                .AddCategory(name, keyword, genitive, false);
    ...
    public void new_category_is_in_List_of_categories_on_Categories_Page() {
        ...
        verify().that(onOpened(AdminMediusCategory.class)
                .categoryIsAdded(name, keyword, genitive, false))
