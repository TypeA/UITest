...
public class IncorrectPasswordTest extends WebTest {
    ...
    public void user_see_message_on_popup(@Named("message") String message) {
        ...
        boolean answer = on(CreateAccountPage.class).createAccountForm.popups.isDisplayed();
    ...
    public void button_Create_Account_is_not_active (){
        boolean answer = on(CreateAccountPage.class).createAccountForm.createAccountButton.isEnabled();
        Assert.assertTrue(answer);
    }
}
