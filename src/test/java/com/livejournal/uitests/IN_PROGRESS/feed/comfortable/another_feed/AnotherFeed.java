package com.livejournal.uitests.IN_PROGRESS.feed.comfortable.another_feed;
...
public class AnotherFeed extends LJTest {
    ...
    public void user_see_only_public_filters() {
        ArrayList<String> groups = onOpened(FriendsFeedLogged.class)
                .openFilters()
                .getAllGroups();
        ArrayList<String> okgroups = getDBDate().friends().getAllPublicGroups(ThucydidesUtils.getFromSession("user").toString(),true);
